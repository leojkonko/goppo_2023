...
class ProductTagEditScreen extends ElliteScreen
{
    protected $model;
     ...
     * @return array
     */
    public function query(ProductTag $model): iterable
    {
        $this->model = $model;
    ...
    public function commandBar(): iterable
    {
        return [
            ...
            parent::getReturnLink('platform.productstags.list'),
    ...
    public function save(ProductTag $model, Request $request)
    {
        return parent::createOrUpdate($model, 'platform.productstags.list', [
            'model.name' => 'required',
        ]);
    }
    ...
    public function toogleField(ProductTag $model)
    {
    ...
    {
        return parent::sortModel(ProductTag::class);
    }

    public static function routes()
    {
        parent::routeEdit('marcas de produtos', 'productstags');
        parent::routeCreate('marcas de produtos', 'productstags');
    }
